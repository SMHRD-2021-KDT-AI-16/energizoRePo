                ...
                <div id="keyword_area">
                    ...
                    <span>
                        ...
                        <script>
                            ...
                            function chatGPT() {
                                const api_key = "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"; // <- API KEY 입력
								const key1 = document.getElementById('keyword_purpose1').value
								const key2 = document.getElementById('keyword_ingre11').value
                                ...
                                const messages = [
                                    { role: 'system', content: 'You are a helpful assistant.' },
                                    {
                                        ...
                                        content:
                                            ...
                                            '이고 피해야 할 식재료는 ' +
                                            key2 +
                                            '기본 : 아침,점심,저녁메뉴, 각메뉴는 하나씩만 알려줘. 구성방식은 1.음식명: [내용 ] 2.식재료: [내용] 3.조리법 : [내용] 식재료는 1인기준 정량으로 레시피는 자세히 알려주고 모든 줄마다 번호를 적어줘. 조건 : (문단뒤에 조건 : +내용). 이것을 토대로 추천해줘.'
                                    },
                                ];
